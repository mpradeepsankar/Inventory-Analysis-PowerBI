...
## 📌 Project Overview
This project focuses on analyzing inventory data to identify stock status, profitability, and warehouse-level performance using Power BI.
...
## 🔍 Analysis Performed
- Stock status analysis (Overstock / Low stock)
